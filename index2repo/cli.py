...
This is a MESS, because it attempts to clean up an even bigger mess.
"""
import os
import logging
import argparse
...
def main():
    ...
    # XXX Randomly selection a sample from ~16000 packages with 4% error
    ...
    for project in projects:
        ...
        try:
            ...
            if not args.all_releases and len(releases) > 0:
